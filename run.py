...
def addcomment():
    ...
    if request.method == 'POST':
        ...
        return render_template('contact_form/success.html', message="Dodano wpis")
...
def contact():
    ...
    if request.method == 'POST':
        ...
        return render_template('contact_form/success.html', message="Wysłano")
